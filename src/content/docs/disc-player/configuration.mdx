---
title: MPD disc player configuration reference
description: 'Reference for go-mpd-discplayer and go-disc-cuer config: MPD connection, audio CD metadata, USB mount modes, scheduled playback, and environment variables.'
howto: true
---
...
<Aside type="note">
The odio installer does not configure scheduled playback — this is a standalone feature of go-mpd-discplayer. On an odio system, scheduled automations are better handled via [Home Assistant](/control/home-assistant/).
</Aside>
