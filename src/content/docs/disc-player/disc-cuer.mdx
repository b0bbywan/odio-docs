---
title: disc-cuer, a CUE file generator with CD metadata
description: Generate CUE files from audio CDs with metadata from GnuDB and MusicBrainz. go-disc-cuer is a Go library and CLI using libdiscid for disc IDs, with caching.
---
