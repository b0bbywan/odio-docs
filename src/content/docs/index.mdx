...
odio is a platform, not a locked appliance. It builds on standard hardware and proven Linux technologies — PulseAudio, MPRIS, D-Bus, systemd — so you're free to install and run any additional software alongside it. See the [Extensions](/guides/extensions/) page for more.
