---
title: odio, an open-source Raspberry Pi audio streamer
description: 'How a Raspberry Pi or Debian system becomes an audio streamer: Bluetooth, AirPlay 2, Spotify Connect, UPnP/DLNA, multi-room, CD and USB, in your user session.'
---
...
This is what the [embedded web UI](/control/embedded-ui/), the [odio application](/control/pwa/), and the [Home Assistant integration](/control/home-assistant/) all build on.
...
Get started with the [Installation guide](/operations/installation/).

## An open platform

odio is a platform, not a locked appliance. It builds on standard hardware and proven Linux technologies — PulseAudio, MPRIS, D-Bus, systemd — so you're free to install and run any additional software alongside it. See the [Extensions](/operations/extensions/) page for more, or read [why it's built this way](/community/empowerment/).
