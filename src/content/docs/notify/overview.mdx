---
title: Event sounds for odio with go-odio-notify
description: 'Pure Go library playing event sounds through PulseAudio for odio: disc insert, USB, Bluetooth connect, disconnect, and errors. Includes a standalone CLI.'
---
