...
description: Apply odio upgrades from Home Assistant or the web UI, or from the command line with the odio-upgrade helper. Pin a release tag, opt out of roles in state.json.
howto: true
---
