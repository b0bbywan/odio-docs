...
Tidal and Qobuz Connect carry a login button on their row. It runs the sign-in helper on the node and shows a link, valid for five minutes, to complete the login from your browser. See the [Tidal](/guides/tidal-qobuz/#tidal-in-the-nodes-library-upmpdcli-plugin) and [Qobuz Connect](/guides/qobuz-connect/) guides for what comes after.
