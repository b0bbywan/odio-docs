---
title: How to power off and manage an odio node
description: Shut down an odio node from the web UI, Home Assistant, the Power API, or SSH, plus exploratory single-switch patterns using a smart plug or a GPIO relay.
howto: true
---

import { Aside } from '@astrojs/starlight/components';

An odio node powers off like any Debian headless box: via the [Power API](/api/power/), via [Home Assistant](/control/home-assistant/), or from the command line. For most setups, that's enough. This page collects patterns for readers who want something more integrated, a single physical switch, or a fully-off state with no standby draw.
...
- From the [embedded web UI](/control/embedded-ui/), the [odio application](/control/pwa/), or [Home Assistant](/control/home-assistant/) — use the Power controls.
