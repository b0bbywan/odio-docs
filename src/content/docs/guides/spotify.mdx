---
title: How to stream Spotify Connect to your odio Pi
description: Turn the odio Pi into a Spotify Connect target via spotifyd. Stream with a Premium account, with MPRIS transport controls and multi-room over Snapcast.
howto: true
---
