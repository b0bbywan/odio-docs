...
Cover art in the embedded UI for CD playback ships since odios [2026.4.0rc6](https://github.com/b0bbywan/odios/releases/tag/2026.4.0rc6), via [mpd2mpris](https://github.com/b0bbywan/mpd2mpris) that finds the `cover.jpg` fetched by [go-disc-cuer](https://github.com/b0bbywan/go-disc-cuer) inside the CUE virtual directory and forwards it over MPRIS. See [MPD playback controls](/guides/mpd/#playback-controls) for the full cover-art pipeline.
