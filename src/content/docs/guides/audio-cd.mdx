...
![Embedded UI playing an audio CD via MPD, Retroaction - A Noisy Blast - Son of Light, with album cover art and full transport controls](../../../assets/audio-cd-playback.webp)

Cover art in the embedded UI for CD playback ships since odios [2026.4.0rc6](https://github.com/b0bbywan/odios/releases/tag/2026.4.0rc6), via the [mpDris2 fork](https://github.com/b0bbywan/mpDris2) that resolves the CUE virtual directory and forwards the cached `cover.jpg` over MPRIS.
