---
title: How to play audio CDs with metadata on odio
description: Insert a CD in a USB optical drive and odio plays it via go-mpd-discplayer, with GnuDB and MusicBrainz metadata, cover art, and MPD transport controls.
howto: true
---
...
![Embedded UI playing an audio CD via MPD, with album cover art and full transport controls](../../../assets/audio-cd-playback.webp)

Cover art in the embedded UI for CD playback ships since odios [2026.4.0rc6](https://github.com/b0bbywan/odios/releases/tag/2026.4.0rc6), via the [mpDris2 fork](https://github.com/b0bbywan/mpDris2) that finds the `cover.jpg` fetched by [go-disc-cuer](https://github.com/b0bbywan/go-disc-cuer) inside the CUE virtual directory and forwards it over MPRIS. See [MPD — Playback controls](/guides/mpd/#playback-controls) for the full cover-art pipeline.
