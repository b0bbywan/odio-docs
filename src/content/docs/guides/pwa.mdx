...
<Aside type="note">Installation as a standalone app requires a browser that supports PWA (Chrome, Edge, Safari, Firefox mobile).

On some other mobile browsers, like DuckDuckGo, the option is available from the three-dot menu:
