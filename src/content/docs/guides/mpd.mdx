...
Since [2026.5.0b1](https://github.com/b0bbywan/odios/pull/56), the [odio API](/api/systemd/) also publishes the myMPD URL alongside `mpd.service`, so the [embedded UI](/guides/embedded-ui/) and [odio application](/guides/pwa/) link to it directly from their services list.
