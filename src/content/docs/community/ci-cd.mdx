...
Six upstream repos feed `.deb` into [apt.odio.love](https://apt.odio.love): the two Go components built in-house ([go-odio-api](https://github.com/b0bbywan/go-odio-api), [go-mpd-discplayer](https://github.com/b0bbywan/go-mpd-discplayer)), the [spotifyd](https://github.com/b0bbywan/spotifyd) fork, [odio-mympd](https://github.com/b0bbywan/odio-mympd), and the two pure-Python rewrites [mpd2mpris](https://github.com/b0bbywan/mpd2mpris) and [snapclientmpris](https://github.com/b0bbywan/snapclientmpris). The flow is:
...
- `gh release list` resolves the latest stable and latest prerelease for the six tracked repos: `go-odio-api`, `go-mpd-discplayer`, `spotifyd`, `mpd2mpris`, `odio-mympd`, `snapclientmpris`. Manual `workflow_dispatch` accepts an explicit version override per repo.
