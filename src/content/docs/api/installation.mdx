---
title: How to install the odio API from APT or Docker
description: Install go-odio-api from the APT repository, deb and rpm packages, multi-arch Docker images, or a source build, then run it as a systemd user service.
howto: true
---
