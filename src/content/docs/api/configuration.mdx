...
`api.cors.origins` lists the origins allowed to call the API from a browser. The defaults cover the hosted [odio application](https://pwa.odio.love); add your own origin here if you [self-host it](/guides/pwa/#other-setups) on a different address.
